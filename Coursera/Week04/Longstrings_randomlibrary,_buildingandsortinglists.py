# -*- coding: utf-8 -*-
"""
Created on Fri Aug 13 09:11:24 2021
...
lstr2 = ("A very long string can also be tied together using ""parentheses to enclose the various parts.")
print(lstr1)
print(lstr2)
...
#%%
print(rlisteven)
print(sorted(rlisteven))      # print sorted versionrsion of rlisteven to see median
#%%
...
#%%
print("For only {:20} dollars!".format(49.651))
#%%
# -phones.py *- coding: utf-8 -*-
"""
